    ...
    window.onload = function() {
        document.getElementById("load") && document.getElementById("load").setAttribute("style", "display:none"),
            ...
            function() {
                ...
                var l = document.createTextNode("Aide");
                ...
                var l = document.createTextNode("Informations éditeur");
                ...
                var l = document.createTextNode("Plein écran");
                m.appendChild(l), i.appendChild(m), t.appendChild(i), e.appendChild(t);
                var t = document.createElement("li");
                ...
                var l = document.createTextNode("sommaire");
